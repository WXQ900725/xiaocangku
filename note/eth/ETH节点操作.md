...
geth attach http://localhost:20001

> 查看节点日志

docker logs -f eth1 --tail 50

> 启动命令:  <font face="微软雅黑" size=5 color=#FF0000 >修改前务必先查询命令的最新版本 $ geth -help</font>
...
交易池选项:
  --txpool.locals value        将逗号分隔的帐户视为局部变量,配置本地的地址列表, 优先包含到交易池中, 且当交易池满了的时候, 不除本地地址的交易
